        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-16 items-center">
          ...
          <div className="lg:col-span-5 text-center lg:text-left">
            <h2 className={commonStyles.heading}>
              AI-Powered Credit Scoring for Fair Lending
            </h2>
            <p className={commonStyles.paragraph}>
              Credloom uses advanced AI algorithms to analyze your on-chain
              activity and generate a trustworthy credit score—without
              compromising your privacy. Get access to loans based on your
              reputation, not your traditional credit history.
            </p>
            <div className="relative inline-flex items-center justify-center mt-10 group">
              ...
              >
                Explore Marketplace <FiExternalLink className="ml-2" />
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-12 text-center sm:text-left">
              <div>
                <h3 className={commonStyles.subHeading}>Instant Loan Approval</h3>
                <p className={commonStyles.subParagraph}>
                  Get matched with lenders in seconds based on your credit
                  score and loan requirements. No lengthy applications or
                  paperwork required.
                </p>
              </div>
              <div>
                ...
                <p className={commonStyles.subParagraph}>
                  All funds are held in secure smart contract escrows,
                  ensuring transparency and eliminating the need for
                  intermediaries.
                </p>
              </div>
            </div>
